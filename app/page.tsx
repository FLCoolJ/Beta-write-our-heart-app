          ...
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg p-4">
                <img src="/new-logo-symbol.png" alt="Write Our Heart" className="w-full h-full object-contain" />
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Add the people you care about with their addresses and special occasions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Our AI helps craft the perfect message and creates beautiful, personalized cards.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">
                  We handle printing, addressing, stamping, and mailing. Your loved ones receive beautiful cards.
                </p>
              </CardContent>
            </Card>
          </div>
